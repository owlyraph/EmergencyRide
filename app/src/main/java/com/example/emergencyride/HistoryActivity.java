...
import com.example.emergencyride.historyRecyclerView.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getUserHistoryIds();
        if(clientOrAmbulance.equals("AmbulanceDrivers")){
        ...
        historyDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(snapshot.child("clientPaid").getValue() != null && snapshot.child("ambulanceDriverPaidOut").getValue() == null){
                        if(snapshot.child("distance").getValue() != null){
                            ridePrice = Double.valueOf(snapshot.child("price").getValue().toString());
                            Balance += ridePrice;
                            mBalance.setText("Balance: " + String.valueOf(Balance) + " KES");
                        }
                    }


                    HistoryObject obj=new HistoryObject(helpId, getDate(timestamp));
