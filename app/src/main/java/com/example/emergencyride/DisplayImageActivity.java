...
public class DisplayImageActivity extends AppCompatActivity {
    ...
    private void listenForChat() {
        final DatabaseReference chatDb = FirebaseDatabase.getInstance().getReference().child("Users").child("ambulancesWorking").child(currentUid).child("received").child(userId);
    ...
    private void listenForStory() {
        DatabaseReference followingStoryDb = FirebaseDatabase.getInstance().getReference().child("Users").child("ambulancesWorking").child(userId);
